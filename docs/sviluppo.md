...
| 6c | Fatto (commit xxxxxxx): dalla prova delle Dune: granelli di sabbia gialli e arancio al posto delle foglie, vento fisso e coerente con i granelli in tutte le Dune; re sparsi a caso entro un perimetro a ogni tentativo (`Scatter`), munizioni più generose, autotest su 5 disposizioni in più | il pallonetto si impara a memoria: con i re che cambiano posto si può essere generosi con le palle |
