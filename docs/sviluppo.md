...
- **Progettare un livello**: una curva di 90° si chiude in circa 5,5 m; un'inversione sposta di 11 m di lato, quindi per rientrare in una porta sul retro si sale lungo il fianco *opposto*. Porte di almeno 1,8 × 2 m. La Cometa può volare fuori dall'isola, sopra le nuvole.
...
| 8c | Fatto (commit xxxxxxx): la **Cometa**, idea dell'utente: una palla che dopo lo sparo si guida col mouse in prima persona (vola dritta e senza gravità a 13 m/s, curva al massimo di 2,4 rad/s, per 7 s o fino al primo urto; SPAZIO la lascia cadere). Nuovi livelli La Cometa (Prati Alti, che salgono a 10) e Le Fornaci (Fucina, 11 livelli): re in case con la porta dalla parte sbagliata. L'IA la pilota lungo una rotta (`GuideHint`); il replay la segue da dietro | l'utente voleva traiettorie impossibili per tiri tesi e pallonetti |
